...
| tests.js | Suite de 37 pruebas financieras reproducibles |
...
Nueve afirmaciones, tres por sesgo. La tercera de cada grupo está invertida para reducir respuestas mecánicas, sin que eso valide el instrumento. Para un ítem invertido, la puntuación corregida es 6 menos respuesta. Para cada grupo:
...
| Libertad financiera | Supuestos -> objetivo -> escenarios -> gráfico y tabla anual | Calcular y comparar tasas e inflación |
...
Se ejecutaron **37 pruebas del núcleo**, todas correctas. verification.json contiene los resultados. Se comprueban Fisher exacto, tasas cero y negativas, equivalencia mensual/anual, primer cruce FIRE, objetivo ya alcanzado, objetivo no alcanzado, retirada cero rechazada, fechas de jubilación incoherentes, independencia de coste de oportunidad, exclusión de transferencias, filtros mensuales, ratios indefinidos y puntuaciones invertidas.
...
10. Navegar con teclado, móvil y zoom; comprobar las tablas alternativas si los gráficos no cargan. Abrir tests.html y comprobar las 37 pruebas.
